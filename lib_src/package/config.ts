...
`,
      ...
      formattingOptions: {
        ...
        description:
          "Specifies [formatting options for `JuliaFormatter.format_text`](https://domluna.github.io/JuliaFormatter.jl/stable/#Formatting-Options-1).",
        type: "object",
        order: 14,
        collapsed: true,
        properties: {
...
to hot-swap to the \`webgl\` renderer.`,
  ...
  juliaSyntaxScopes: {
    ...
    description: `The listed syntax scopes (comma separated) will be recoginized as Julia files. \
...
**DO NOT** edit this unless you\'re sure about the effect.`,
  ...
  disableProxy: {
    ...
    description: `This unsets the \`HTTP_PROXY\` and \`HTTPS_PROXY\` environment variables in all integrated \
