...
const { workspace, gotosymbol: gotoSymbol, clearLazy } = client.import({
  ...
  onClick(name) {
    return () => {
      ...
      return gotoSymbol({
        ...
        return this.ink.goto.goto(symbols, { pending: atom.config.get("core.allowPendingPaneItems") })
      })
    }
  },
