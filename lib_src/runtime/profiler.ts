...
export function activate(ink) {
  ...
  subs.add(
    atom.config.observe("julia-client.uiOptions.layouts.profiler.defaultLocation", defaultLocation => {
  ...
  subs.add(
    atom.commands.add("atom-workspace", "julia-client:load-profile-trace", () => {
